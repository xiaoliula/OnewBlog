...
keywords: 
description:
top_img: https://img.onedabuliu.cn/file/onew11726800156562963.jpg
comments: true
cover: https://img.onedabuliu.cn/file/onew11726800156562963.jpg
toc:
toc_number:
toc_style_simple:
copyright:
...
![image.png](https://img.onedabuliu.cn/file/11726117618657892.png)
...
![image.png](https://img.onedabuliu.cn/file/11726118134357498.png)
...
![image.png](https://img.onedabuliu.cn/file/11726118755301318.png)

最后一个就是[US.KG ](https://nic.us.kg/)，这个网址能够注册三个免费的域名，每次能申请一年，只需要每过了半年就可以进行一次续费，而且是免费续费。注册的时候是可以用谷歌账号登录，也可以虚拟信息配合QQ邮箱进行注册。

![image.png](https://img.onedabuliu.cn/file/11726119144156866.png)

# 托管到cf
这里托管就用us.kg的域名进行演示，可以提前注册一个cf的账号。域名申请好后进入cf的控制面板，点击添加域

![image.png](https://img.onedabuliu.cn/file/11726119441048703.png)

输入刚才你注册的域名

![image.png](https://img.onedabuliu.cn/file/11726119504742103.png)

点击继续，然后往下滑，选择免费，然后无脑下一步

![image.png](https://img.onedabuliu.cn/file/11726119683836745.png)
![image.png](https://img.onedabuliu.cn/file/11726119686825748.png)

添加完成后上方显示待处理...，先不用管，点击DNS

![image.png](https://img.onedabuliu.cn/file/11726119776986437.png)

往下滑，找到这个

![image.png](https://img.onedabuliu.cn/file/11726119810290585.png)

复制下来，然后打开us.kg的控制台页面，在首页往下滑找到manage my domains

![image.png](https://img.onedabuliu.cn/file/11726119947867881.png)

点击进入选择你要托管的域名，把刚才复制下来的分别填入第一和第二个方框就OK了

![image.png](https://img.onedabuliu.cn/file/11726120034043120.png)

接下来就等待状态从第一个变成第二个就大功告成了

![image.png](https://img.onedabuliu.cn/file/11726120124786280.png)
