...
date: 2022-10-23 09:23:44
updated: 2022-10-23 09:23:44
...
comments:
copyright: true
copyright_author: Onew
copyright_author_href: https://blog.onew.us.kg/
copyright_url: http://blog.onew.us.kg/2023/06/01/%E4%B8%BB%E9%A2%98%E6%A0%87%E7%AD%BE/
ai: 
  - "这篇文章介绍了Onew主题标签Tag Plugins，是一个能够帮助提升文章权重和博主认知度的标签，可用于博文、日记和笔记等多种形式的内容。通过使用Ta标签，可以快速定位感兴趣的话题和关键字。此外，Onew还提供了一些Tag Plugins相关的服务，如搜索和热门标签推荐等。"
  - 这篇文章介绍了Onew主题标签Tag Plugins，是一个能够帮助提升文章权重和博主认知度的标签，可用于博文、日记和笔记等多种形式的内容。通过使用Ta标签，可以快速定位感兴趣的话题和关键字，可以用于文章内快速书写相应格式的html
  - 这篇文章介绍了Onew主题标签，在hexo主题AnZhiYu中可以使用Tag Plugins快速完成对应的标签生成书写。
---

{% note blue 'anzhiyufont anzhiyu-icon-bullhorn' simple %}
`主题`中大部分标签移植于[店长](https://akilar.top/)的[hexo-butterfly-tag-plugins-plus](https://blog.anheyu.com/posts/d50a.html)
{% endnote %}
...
<iframe  class="bilibili"  src="//player.bilibili.com/player.html?isOutside=true&aid=264116147&bvid=BV1ze411c7xm&cid=933249499&p=1"  scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" sandbox="allow-top-navigation allow-same-origin allow-forms allow-scripts"></iframe>