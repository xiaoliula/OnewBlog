...
keywords: 
description:
top_img: https://img.onedabuliu.cn/file/onew117364046699359.webp
comments: true
cover: https://img.onedabuliu.cn/file/onew117364046699359.webp
toc:
toc_number:
toc_style_simple:
copyright:
...
![image.png](https://img.onedabuliu.cn/file/onew11736400717422830.png)
...
![image.png](https://img.onedabuliu.cn/file/onew11736401103802572.png)
...
```
![image.png](https://img.onedabuliu.cn/file/onew11736401296324885.png)
...
![image.png](https://img.onedabuliu.cn/file/onew1173640150129170.png)
...
![image.png](https://img.onedabuliu.cn/file/onew11736401650896826.png)
...
net start mysql8
```
![image.png](https://img.onedabuliu.cn/file/onew11736401789977719.png)

在任务管理器中的服务也可以启动服务

![image.png](https://img.onedabuliu.cn/file/onew11736401839950712.png)
...
![image.png](https://img.onedabuliu.cn/file/onew11736402013545532.png)
![image.png](https://img.onedabuliu.cn/file/onew11736402116826171.png)
...
```
![image.png](https://img.onedabuliu.cn/file/onew11736402347069920.png)
...
![image.png](https://img.onedabuliu.cn/file/onew11736402965361213.png)

这里可以看到我刚才新的mysql8的数值数据指向的地址确实之前安装mysql5的路径，所以这里是不对的，将下面的内容前面的路径内容改为自己mysql8正确的路径即可

修改前：
![image.png](https://img.onedabuliu.cn/file/onew11736403038504221.png)

修改后（(注意只需要修改路径，后面的mysqld mysql8这个内容不需要动)）：

![image.png](https://img.onedabuliu.cn/file/onew11736403060904481.png)
